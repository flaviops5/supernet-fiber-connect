                      ...
                      <AccordionTrigger className="px-6 py-6 hover:no-underline group">
                        <div className="flex items-center gap-4 text-left">
                          ...
                          <div className="flex-1">
                            <h3 className="text-base font-sans text-foreground group-hover:text-[#4d64ae] transition-colors leading-tight">
                              {faq.question}
                            </h3>
                          </div>
                        </div>
                    ...
                    <AccordionItem value={`item-${adjustedIndex}`} className="border-none">
                      <AccordionTrigger className="px-6 py-6 hover:no-underline group">
                        <div className="flex items-center gap-4 text-left">
                          ...
                          <div className="flex-1">
                            <h3 className="text-base font-sans text-foreground group-hover:text-[#f48120] transition-colors leading-tight">
                              {faq.question}
                            </h3>
                          </div>
                        </div>

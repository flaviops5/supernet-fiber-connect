...
const Header = () => {
  ...
  const services = [
    { name: 'Internet Fibra', href: '/fibra' },
    { name: 'Telemedicina', href: '/telemedicina' },
    { name: 'Energia Solar', href: '/energia-solar' },
    { name: 'Monitoramento Residencial', href: '/monitoramento-residencial' },
    { name: 'Monitoramento Veicular', href: '/monitoramento-veicular' },
    { name: 'Streaming', href: '/streaming' },
    { name: 'Automação Residencial', href: '/automacao' },
  ];

  const products = [
    { name: 'Câmeras de Segurança', href: '/produtos/cameras' },
    { name: 'Roteadores', href: '/produtos/roteadores' },
    { name: 'Fire TV Stick', href: '/produtos/firestick' },
  ];
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            >
              ...
              {activeDropdown === 'services' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-card rounded-lg shadow-elegant border border-border p-4">
            ...
            >
              ...
              {activeDropdown === 'products' && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-card rounded-lg shadow-elegant border border-border p-4">
                  <div className="space-y-2">

-- ============================================
-- FIX: Align RPC with existing table schema
-- ============================================
-- Replace create_installation_appointment to insert into actual columns
...
BEGIN
  ...
  -- Insert appointment using existing columns
